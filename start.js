...
require('./index.js')
nocache('./index.js', module => console.log(`${module} Auto Update © Nekell H4xor`))

async function starts(herman = new WAConnection()){
  herman.logger.level = 'warn';
  herman.version = [2, 2146, 9]
  herman.browserDescription = [ 'NekellH4xor', 'Safari', '3.0' ];
...
function nocache(module, cb = () => {}) {
  console.log("Module", `'${module}'`, "Sc Ni Masih Di Kembang kan Oleh Lord Nekell H4xor");
